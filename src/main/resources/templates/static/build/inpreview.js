function ContentLetter(_ref) {
    ...
    return React.createElement(
        React.Fragment,
        null,
        React.createElement('iframe', { id: 'invoiceprint', name: 'frame1', src: '/invoiceprint.html?id=6181b2c0-5952-40de-83a7-0a9e76282fde', width: '100%', height: '800' })
    );
}
function MenuPrint() {
...
function InpreviewMain() {
    ...
    React.useEffect(function () {
        var params = new URL(document.location).searchParams;
        var id = params.get("id");
        labkodingMain().fetchOneInvoiceById(id, function () {
    ...
    return React.createElement(
        React.Fragment,
        null,
        ReactDOM.createPortal(React.createElement(MenuPrint, null), document.querySelector('#pin-page')),
...
ReactDOM.render(React.createElement(
    ContextOneProvider,
    null,
    React.createElement(InpreviewMain, null)
